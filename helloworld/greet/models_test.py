...
def test_for_time_of_day():
    assert "goodmorning" == Greeting.for_time_of_day(time.fromisoformat("09:30:57")).slug
    assert "goodevening" == Greeting.for_time_of_day(time.fromisoformat("18:03:09")).slug
